...
n1=3010 & n2=fix(0.01d0/dt);long(1./dt)+1;	;Replot n1 times (after n2 timesteps)
print,'n1,n2',n1,n2
...
;
;  Advective flux
U0=0.;0.45;0.1		;Vertical mean velocity in normalized units h/td; SSSB06 uses U0=0.3-3 corresponding to 0.2-2 km/s; CSS12 uses R_Uz=0.45
;  New Vishniac flux
