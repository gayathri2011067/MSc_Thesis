module parameters
  ...
  !WITH DIMENSION
      ...
      double precision, parameter :: eta_dim_0 = 0.1d27*s_Gyr/(cm_kpc**2.) ! cm2/s --> kpc2/Gyr
      ...
      double precision, parameter :: u_zero_dim = 10. *s_Gyr/km_kpc
  ...
  !DIMENSIONLESS
      ...
      double precision, parameter :: eta_0 = eta_dim_0/(h_dim**2/t_d_dim) !NOTE: use profile for thick disc
      ...
      double precision, parameter :: k = k_dim/(h_dim**2/t_d_dim) !NOT_SURE
      ...
      double precision, parameter :: tau = tau_dim/(h_dim**2./(h_dim**2/t_d_dim))
      ! double precision, parameter :: B_0 = B_0_dim/(B_0_dim)
      double precision, parameter :: rho = 1. !NOT_SURE!set some correct value
      double precision, parameter :: u_zero = u_zero_dim/u_zero_dim
